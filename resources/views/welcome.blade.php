...
<body class="bg-white text-gray-800 font-sans">
  ...
  <nav class="bg-white shadow-md fixed top-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center space-x-6">
          <a href="#features" class="text-gray-700 hover:text-blue-600 hover:underline">Fitur</a>
          <a href="#cta" class="text-gray-700 hover:text-blue-600 hover:underline">Mulai</a>
          <a href="/login" class="text-gray-700 hover:text-blue-600 hover:underline">Login</a>
    ...
    <div id="mobile-menu" class="md:hidden hidden px-4 pb-4 space-y-2">
      <a href="#features" class="block text-gray-700 hover:text-blue-600 hover:underline">Fitur</a>
      <a href="#cta" class="block text-gray-700 hover:text-blue-600 hover:underline">Mulai</a>
      <a href="/login" class="block text-gray-700 hover:text-blue-600 hover:underline">Login</a>
